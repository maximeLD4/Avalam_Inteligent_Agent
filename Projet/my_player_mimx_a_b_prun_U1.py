...
class MyAgent(Agent):
    ...
    def play(self, percepts, player, step, time_left):
        ...
        def utility_2(board):
            ...
            nb_tower_of_one_positive = 0
            nb_tower_of_one_negative = 0
            ...
            if player > 0:
                return positives_tower_score_1 + nb_tower_of_one_positive**2
            elif player < 0:
                return negatives_tower_score_1 - nb_tower_of_one_negative**2
