...
python MaximeLDAhmedD_vscore.py --bind localhost --port 8080
python MaximeLDAhmedD_vscore.py --bind localhost --port 8010
python game.py http://localhost:8080 http://localhost:8010 --time 900 --verbose --no-gui
"""
import random
from avalam import *
import numpy as np
